		...
		for(int r = 0; r < sizeR; r++) {
			for(int c = 0; c < sizeC; c++) {
				if(map[r][c].wall[EAST].present && !map[r][c].wall[EAST].drawn) {
					StdDraw.line(c + 1, r, c + 1, r + 1); map[r][c].wall[EAST].drawn = true;
				}
				if(map[r][c].wall[NORTH].present && !map[r][c].wall[NORTH].drawn) {
					StdDraw.line(c, r + 1, c + 1, r + 1); map[r][c].wall[NORTH].drawn = true;
				}
				if(map[r][c].wall[WEST].present && !map[r][c].wall[WEST].drawn) {
					StdDraw.line(c, r, c, r + 1); map[r][c].wall[WEST].drawn = true;
				}
				if(map[r][c].wall[SOUTH].present && !map[r][c].wall[SOUTH].drawn) {
					StdDraw.line(c, r, c + 1, r); map[r][c].wall[SOUTH].drawn = true;
				}
			}
		}
	} // end of draw()
